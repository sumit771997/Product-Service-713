...
public class ProductModel {
	...
	@Pattern(regexp = "^[a-zA-Z\\s]+\\d*$", message = "Product name should only contain alphabets ,spaces and numbers")
	...
	public ProductModel(long productId,
			@NotBlank(message = "Product name should not be blank") @Pattern(regexp = "^[a-zA-Z\\s]+\\d*$", message = "Product name should only contain alphabets ,spaces and numbers") String productName,
